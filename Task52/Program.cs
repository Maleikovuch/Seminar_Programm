...
// int[,] CreateMatrixNumbersIntegers(int rows, int columns, int min, int max)
// {
//     int[,] matrix = new int[rows, columns];
//     var rnd = new Random();
...
//             sum = sum + matrix[i, j];
//         }
//         findAverageElementsColumns[j] = sum / matrix.GetLength(0);
//     }
//     return findAverageElementsColumns;
// }
...
// int[,] arr = CreateMatrixNumbersIntegers(3, 4, 1, 9);
// PrintMatrix(arr);
